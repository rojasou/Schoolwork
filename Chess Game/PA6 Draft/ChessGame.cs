...
namespace PA6_Draft
{
    internal delegate void Checkmate();
    internal delegate void PlayerMove();
    internal delegate void Capture();
    internal delegate void Check();
    internal delegate void Stalemate();
    internal delegate void Time10Sec();
    internal delegate void FirstMove();
    internal delegate void GameHistory(Move move);
    ...
    class ChessGame
    {
        ...
        internal event PlayerMove PlayerMove;
        internal event Capture Capture;
        internal event Check Check;
        internal event Checkmate Checkmate;
        internal event Stalemate Stalemate;
        internal event Time10Sec Time10Sec;
        internal event FirstMove FirstMove;
        internal event GameHistory GameHistory;
